...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   var total = 0;
   arrayOfNums.forEach( valor => total = total + valor);
   return total;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   var nroElementos = resultadosTest.length;
   var sumaElementos = 0;
   resultadosTest.forEach( nota => sumaElementos = sumaElementos + nota);
   return sumaElementos / nroElementos;
}
